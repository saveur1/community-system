...
import { FaEdit, FaEye, FaEllipsisV, FaExclamationTriangle } from 'react-icons/fa';
                      ...
                      <div className="flex items-center space-x-3 md:space-x-4">
                        ...
                        <div className="relative">
                          <CustomDropdown
                            ...
                            portal={true}
                            dropdownClassName="bg-white border border-gray-200 rounded-lg shadow-lg py-1 min-w-48 z-50"
                          >
