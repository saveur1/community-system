...
interface AssignedToolbarProps {
  viewMode: 'list' | 'grid';
...
export const AssignedToolbar = ({ viewMode, onViewModeChange, search, onSearchChange, filteredCount }: AssignedToolbarProps) => {
  return (
    <div className="flex w-full bg-white px-4 py-2 my-6 border border-gray-300 rounded-md items-center mb-6">
      <div className="flex items-center">
        <h2 className="text-xl font-bold text-gray-600 mr-2">Assigned Immunizations</h2>
