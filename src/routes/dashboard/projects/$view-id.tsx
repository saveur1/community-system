...
import { FaChevronLeft, FaChevronRight, FaFolderOpen, FaListOl, FaUsers, FaSort, FaSortUp, FaSortDown, FaEye, FaTag, FaUpload, FaTrash, FaEdit, FaSave, FaTimes, FaCalendarAlt, FaMapMarkerAlt, FaClock, FaBuilding } from 'react-icons/fa';
