...
const CommunitySessionsPage = () => {
  ...
  return (
    <div className="pb-6 lg:pb-10 px-2 lg:px-0">
      <Breadcrumb title="Community Sessions" items={['Dashboard', 'Community Sessions']} className='absolute top-0 left-0 w-full px-4 lg:px-6'/>
      <div className="pt-20">
        ...
        <div className="flex flex-col gap-3 lg:gap-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            {checkPermissions(user, 'community_session:create') && (
              <Link to="/dashboard/community-sessions/add-new" className="bg-primary flex items-center gap-2 text-white px-4 lg:px-5 py-2 lg:py-2.5 rounded-lg hover:bg-primary-dark transition-colors font-medium shadow-sm cursor-pointer text-sm lg:text-base">
          ...
          <div className="w-full">
            <input
              ...
              className="w-full max-w-md border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 text-sm lg:text-base"
            />
          </div>
        </div>
      </div>
