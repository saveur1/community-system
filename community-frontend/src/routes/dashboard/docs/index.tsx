...
function UsageCard({ icon, title, children }: { icon: React.ReactNode; title: string; children: React.ReactNode }) {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-5">
    ...
    <div className="pb-10">
      ...
      <div className="pt-20 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Community Tool — Overview</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <UsageCard icon={<FaClipboardList size={18} />} title="Surveys — gather structured feedback">
            ...
            <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">Tip: Use the report-form type for official reporting workflows.</div>
          </UsageCard>
          ...
          <UsageCard icon={<FaCommentDots size={18} />} title="Feedback — collect unstructured input">
            ...
            <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">Tip: Attach project or location metadata to filter feedback by program.</div>
          </UsageCard>
          ...
          <UsageCard icon={<FaVideo size={18} />} title="Community Sessions — host resources & discussions">
            ...
            <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">Tip: Use sessions to share training videos and collect community questions.</div>
          </UsageCard>
          ...
          <UsageCard icon={<FaUsers size={18} />} title="Stakeholders & Roles — manage access and responsibilities">
            ...
            <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">Tip: Keep stakeholder roles scoped to necessary permissions for least privilege.</div>
          </UsageCard>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600 p-6">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">Example end-to-end scenario</h2>
          <div className="text-sm text-gray-600 dark:text-gray-300 space-y-2">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">This workflow uses Surveys, Feedback, Stakeholders and Reporting features together.</p>
          </div>
        </div>
      </div>
    </div>
