    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Delete Feedback" size="md">
      <ModalBody>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-gray-800 dark:text-gray-200 font-medium mb-1">You are about to permanently delete this feedback.</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">This action cannot be undone. All related data will be permanently removed.</p>
            ...
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" htmlFor="confirmTitle">
              Feedback Title
            </label>
            <input
              id="confirmTitle"
              ...
              className="w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500"
            />
          </div>
        </div>
      </ModalBody>
