...
import Profile from '@/components/pages/dashboard/header-profile';
  ...
  return (
    <header className="flex bg-white dark:bg-gray-800 border-b border-gray-200 items-center w-full justify-between px-4 py-4">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Right Profile */}
        <Profile collapsed={false} user={user} />
      </div>
...
const DashboardLayout: React.FC = () => {
  ...
  const navItems: NavItemType[] = [
    ...
    { name: "Events", icon: HiCalendar, active: false, link: `/${path}/events` },
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <Sidebar
        ...
        navItems={navItems}
      />
      <div className={`flex-1 transition-all duration-300 ease-in-out py-0 ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-16'
        }`}>
