...
export const SelectDropdown: React.FC<SelectDropdownProps> = ({
  ...
  const trigger = (
    <div className={cn(`grid w-full cursor-default grid-cols-1 rounded-md bg-white py-2.5 pr-2 pl-3 text-left outline-1 -outline-offset-1 outline-gray-300 sm:text-sm ${
